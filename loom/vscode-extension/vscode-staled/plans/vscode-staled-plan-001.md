...
<!-- step:fix-createplannode-stale-condition-replace-plan -->
...
<!-- step:build-staleids-set-in-getweavechildren-getthreadchildren -->
...
<!-- step:apply-stale-badge-in-createdocumentnode-when -->
