...
export const toolDef = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            weaveId: { type: 'string', description: 'Weave to delete (whole folder, live or archived), or the weave of the thread to delete' },
            threadId: { type: 'string', description: 'Thread to delete (requires weaveId)' },
            archivedRelPath: { type: 'string', description: 'Path (relative to loom/.archive/) of an archived reference to permanently delete' },
        },
        required: [],
    },
};
